# Example of running cucumber/gherkin-syntaxed specs with Cypress.io over Supervielle

The **supervielle-test-automation-framework** adds support for using feature files when testing with Cypress.
...
Feature: Search for ads
  ...
  on Supervielle has at least 1 item to be bought.

  Scenario: Customer searches for "Iphone" and see at least 1 item to buy on the second ad at the second results page
    Given the customer has navigated to Supervielle home page
    When the customer searches for "Iphone" on Supervielle searchbox
    Then Supervielle 1° results page is correctly displayed
    When the customer clicks on "Next" button at Supervielle results page paginator
    Then Supervielle 2° results page is correctly displayed
    And a 2° ad is correctly displayed at Supervielle 2° results page
